...
> **pac CLI alpha:** The pac CLI team is adding native cliagent-1.0.0 support.
> Alpha builds: [CAP_ISVExp_Tools_Daily](https://dev.azure.com/msazure/One/_artifacts/feed/CAP_ISVExp_Tools_Daily).
> This toolkit is a tested bridge for stable pac CLI 2.8.x — check the alpha before deciding.
